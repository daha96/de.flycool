...
public class SettingsFragment extends PreferenceFragment {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getPreferenceScreen().findPreference("pref_key_warnings_msl_min").setOnPreferenceChangeListener(onPreferenceChangeListener);
	 ...
	 */
	public static Integer getSetting(SharedPreferences sharedPref, WarnLevel warnLevel,
	...
	OnPreferenceChangeListener onPreferenceChangeListener = new OnPreferenceChangeListener() {
		...
		public boolean onPreferenceChange(Preference preference, Object newValue) {
			...
			{
				Integer val = getSetting(WarnLevel.warn, ReferenceAttitude.msl, MinMax.max);
